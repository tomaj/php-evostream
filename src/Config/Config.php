    ...
    public function __call($name, $arguments)
    {
        if (substr($name, 0, 3) == 'set' && strlen($name) > 3) {
            ...
            if (!isset($arguments[0])) {
                throw new ConfigException("There is no field '$name' in this command config");
            }
        ...
        throw new ConfigException("You are trying to set unknown property '$name' to command config");
    }
